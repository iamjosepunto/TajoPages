...
// Dominio propio del sitio: se usa en URLs, canonicals y sitemap
...
function prerenderizar(): Plugin {
  return {
    ...
    closeBundle() {
      ...
      console.log(`tajopages-prerender: ${generadas} paginas, 404.html y sitemap.xml`)
    }
  }
}

export default defineConfig({
  // Dominio propio: el sitio se sirve desde la raiz, no desde /TajoPages/
  base: '/',
